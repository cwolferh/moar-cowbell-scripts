...
vftool.bash run "grep -q 'release 6' /etc/redhat-release && sed -i 's/#RPCNFSDARGS=\"-N 4\"/RPCNFSDARGS=\"-N 4\"/' /etc/sysconfig/nfs;
grep -q 'release 7' /etc/redhat-release && sed -i 's/RPCNFSDARGS=\"\"/RPCNFSDARGS=\"-N 4\"/' /etc/sysconfig/nfs;
...
/sbin/service rpcbind restart; sleep 4; /sbin/service nfs stop; sleep 4; /sbin/service nfs start; sleep 4; /sbin/service nfs restart;
